import { playUiSound, playGameplaySounds } from "../audio/ui-audio.js?v=svg-test-39";
import { createBoogaState } from "../game/booga-state.js?v=svg-test-39";
import { dispatchDirection, prepareLaunch, launchSpell, scanState, selectElement } from "../game/booga-actions.js?v=svg-test-39";
import { addLogMessage } from "../game/demo-state.js?v=svg-test-39";
import { createLogView } from "./log.js?v=svg-test-39";
import { renderArena } from "./arena-svg.js?v=svg-test-39";
import { bindKeyboardControls } from "./keyboard-controls.js?v=svg-test-39";
